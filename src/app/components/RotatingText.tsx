...
const RotatingText = forwardRef<RotatingTextRef, RotatingTextProps>(
  (
    ...
    // TEST (12-1-25): Compute max length so in-line text width stays constant and doesn't shift any words
    ...
    return (
      <motion.span
        ...
        // TEST (12-1-25): Include max length so in-line text width stays constant and doesn't shift any words
